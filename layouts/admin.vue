<template>
  <v-app>
    ...
    >
      <div
        class="px-12 d-flex flex-column justify-center justify-md-start flex-md-row align-center gap-3 py-4"
        style="width: 100%"
      >
        <div v-if="isMobile" class="d-flex justify-space-between width-100">
          <v-img
            :src="require(`~/assets/leave.svg`)"
            max-height="50"
            max-width="50"
          />
    ...
    <v-main
      class="text--text app-background"
      :class="{ 'main-mobile': isMobile, 'main-drawer': drawer }"
    >
      <v-main>
